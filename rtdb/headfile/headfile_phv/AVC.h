...
#define AVC_TAB_FcUnit_FIELD_iReqOn_INDEX                   	2	//需要投入
#define AVC_TAB_FcUnit_FIELD_iReqOff_INDEX                  	3	//需要退出
#define AVC_TAB_FcUnit_FIELD_iStatus_INDEX                  	4	//机组运行状态
#define AVC_TAB_FcUnit_FIELD_iOnOffTimes_INDEX              	5	//电容器当天投切次数
#define AVC_TAB_FcUnit_FIELD_iFlag_INDEX                    	6	//标识
#define AVC_TAB_FcUnit_FIELD_fcurCap_INDEX                  	7	//额定容量(kVar)
#define AVC_TAB_FcUnit_FIELD_iGroup_INDEX                   	8	//组号
#define AVC_TAB_FcUnit_FIELD_fOnffMaxTimes_INDEX            	9	//电容器当天最大投切次数
#define AVC_TAB_FcUnit_FIELD_tSnapTime_INDEX                	10	//时标量
#define AVC_TAB_FcUnit_FIELD_iEnabled_INDEX                 	11	//启用标识
#define AVC_TAB_FcUnit_FIELD_iStatusDigitID_INDEX           	12	//机组状态对应遥信ID
#define AVC_TAB_FcUnit_FIELD_iOnOffTimesAlgID_INDEX         	13	//电容器当天投切次数测ID
#define AVC_TAB_FcUnit_FIELD_iOnFlgDigitID_INDEX            	14	//需要投入标识遥信ID
#define AVC_TAB_FcUnit_FIELD_iOffFlgDigitID_INDEX           	15	//需要退出标识遥信ID
#define AVC_TAB_FcUnit_FIELD_iQuality_INDEX                 	16	//质量码
