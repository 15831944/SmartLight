...
#define SCADA_TAB_Relay_FIELD_iZF_INDEX                     	11	//是否转发通道
...
#define SCADA_TAB_SetPoint_FIELD_iZF_INDEX                  	12	//是否转发通道
...
#define SCADA_TAB_Global_FIELD_iFormulaPeriod_INDEX         	5	//计算公式计算间隔(m)
